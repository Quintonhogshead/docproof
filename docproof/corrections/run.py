...
CHECK_AFTER: dict[str, str] = {
    ...
    "align-left": "this paragraph is now set flush left",
    "align-right": "this paragraph is now set flush right",
    "align-center": "this paragraph is now centred",
    "justify": "this paragraph is now justified",
    "no-indent": "the first-line indent here is gone — check it sits flush",
    "first-line-indent": "the first-line indent here was set — check the amount",
    "left-indent": "this paragraph was indented from the left",
    "right-indent": "this paragraph was indented from the right",

...
COMMON_RULES: tuple[str, ...] = (
    ...
    "compound modifiers (“well-known author”), ages (“a twelve-year-old”), "
    "and prefixes (“pre-marriage”); a compound whose adverb ends in -ly is "
    ...
    "given “:00”; a spelled-out hour never becomes digits. A range takes an "
    "unspaced en dash (“9:00–5:00 p.m.”).",

...
def _number_policy() -> str:
    ...
    sections.append(
        ...
        "or time value. The date-order sweep owns a U.S.-oriented book's day-month-"
        "year dates too (“11 April 1941” -> “April 11, 1941”): never re-flag a date "
        "already in month day, year order, and never change a date's day, month or "
        "year value. Preserve legitimate years, identifiers, measurements, "
